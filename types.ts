export type ViewState = 'home' | 'shop' | 'product' | 'academy' | 'marcas' | 'profile' | 'cart' | 'auth' | 'size-guide' | 'admin' | 'checkout' | 'support' | 'forgot-password' | 'update-password' | 'events' | 'event-detail' | 'event-registration' | 'event-results' | 'organizer' | 'sponsor-event' | 'zona-running';
