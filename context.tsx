...
const MOCK_EVENTS: Event[] = [
  {
    ...
    city: 'Bogotá',
    description: 'La maratón más emblemática de la capital colombiana. Recorre las principales vías de Bogotá en un entorno lleno de energía, música y miles de corredores apasionados.\n\nExperimenta la altura de la ciudad y ponte a prueba en esta exigente pero gratificante competencia. Contaremos con puntos de hidratación cada 2KM, servicio médico especializado, y una espectacular zona de recuperación en la meta con masajes y sorpresas de nuestros patrocinadores.',
    price: 150000,
  ...
  },
  {
    ...
    city: 'Bogotá',
    description: 'Únete a la marea rosa en esta carrera dedicada a la fuerza y valentía de la mujer colombiana.\n\nEs un evento pensado para inspirar, empoderar y celebrar la vida mediante el deporte. Todo el recorrido estará adornado y habrá actividades especiales de calentamiento, zonas de fotos exclusivas y una espectacular medalla conmemorativa al final. ¡Un evento imperdible para ti y tus amigas!',
    price: 90000,
