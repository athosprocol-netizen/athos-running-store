      ...
      <div className="mb-6 md:mb-12">
          ...
          <div className="flex gap-3">
              ...
              <button 
                ...
                className={`flex-shrink-0 w-[56px] h-[56px] rounded-[20px] flex items-center justify-center transition-all shadow-sm ${
                    isFiltersOpen ? 'bg-athos-black text-white' : 'bg-white text-athos-black hover:bg-athos-orange hover:text-white'
                }`}
              >
          ...
          <div className="flex items-center gap-3 overflow-x-auto hide-scrollbar pb-2">
              {categories.map(cat => (
                  <button
                      ...
                      className={`whitespace-nowrap px-6 py-3 text-xs font-bold uppercase tracking-wide rounded-[16px] transition-all border ${
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
                    {paginatedProducts.map((product, idx) => {
                        ...
                        return (
                            <div 
                                key={product.id} 
                                className="bg-white p-3 md:p-4 rounded-[24px] relative group cursor-pointer hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
