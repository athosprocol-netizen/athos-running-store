...
export const Challenges = () => {
    ...
    return (
        <div className="pt-24 pb-24 px-4 md:px-8 max-w-6xl mx-auto min-h-screen bg-transparent animate-fade-in">
            ...
            <div className="flex gap-2 mb-8 overflow-x-auto hide-scrollbar">
                {['All', 'Road', 'Trail'].map(f => (
                    <button
                        ...
                        className={`px-6 py-2.5 rounded-full text-xs font-bold uppercase tracking-wide transition-all border ${filter === f
                            ...
                            <div className="px-2 pb-2 flex flex-col flex-grow">
                                ...
                                <div className="mt-auto pt-3 border-t border-gray-300/50 flex justify-between items-center">
                                    ...
                                    <button
                                        ...
                                        disabled={isJoined}
                                        className={`px-5 py-2 rounded-xl font-black text-[10px] uppercase tracking-wide transition-all ${isJoined
