      ...
      <div className="max-w-[1400px] mx-auto md:px-10">
        ...
        <div className="mt-2 px-6 md:px-0">
            ...
            >
                ...
                >
                    <div className="bg-athos-black rounded-[24px] md:rounded-[40px] p-5 md:p-14 h-[150px] md:h-[450px] relative overflow-hidden flex items-center shadow-xl shadow-athos-black/20 group transition-transform active:scale-[0.99]">
                        <div className="relative z-10 w-[68%] md:w-[60%] pointer-events-none flex flex-col justify-center h-full">
                            ...
                            <span 
                                className="inline-block bg-white text-athos-black px-2.5 py-1 md:px-10 md:py-4 rounded-lg md:rounded-2xl text-[7px] md:text-sm font-black uppercase tracking-widest group-hover:bg-athos-orange group-hover:text-white transition-all shadow-lg w-fit"
                            >
                                Comprar Ahora
                            </span>
                        </div>
                ...
                <div 
                    ...
                    onClick={() => handleItemClick(() => setView('shop'))}
                >
                    <div className="bg-gray-100 rounded-[24px] md:rounded-[40px] p-5 md:p-14 h-[150px] md:h-[450px] relative overflow-hidden flex items-center border border-gray-200 group transition-transform active:scale-[0.99]">
                        <div className="relative z-10 w-[65%] md:w-[60%] pointer-events-none flex flex-col justify-center h-full">
                            ...
                            <span 
                                className="inline-block bg-athos-black text-white px-2.5 py-1 md:px-8 md:py-4 rounded-lg md:rounded-2xl text-[7px] md:text-sm font-black uppercase tracking-widest group-hover:scale-105 transition-transform w-fit"
                            >
                                Ver Todo
                            </span>
                        </div>
        ...
        <div className="mt-8 md:mt-16 px-6 md:px-0">
            <div className="flex justify-between items-center mb-5 md:mb-8">
                ...
                <button onClick={() => setView('shop')} className="text-xs md:text-sm font-bold text-athos-orange hover:text-black transition-colors flex items-center gap-1">Ver todo <ArrowRight size={14}/></button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 md:flex md:justify-start md:gap-16 p-2">
                {categories.map((cat) => (
                    <button key={cat.id} onClick={() => setView('shop')} className="flex flex-col items-center gap-3 group w-full">
                        <div className="w-16 h-16 md:w-32 md:h-32 bg-[#F4F4F4] rounded-full flex items-center justify-center text-athos-black group-hover:bg-athos-orange group-hover:text-white transition-all shadow-sm group-hover:shadow-lg duration-300">
                ...
                {displayProducts.map((product) => {
                    ...
                    return (
                        <div key={product.id} className="group cursor-pointer" onClick={() => selectProduct(product.id)}>
                            ...
                            <div className="bg-[#F4F4F4] rounded-[24px] md:rounded-[30px] p-4 md:p-6 aspect-[4/5] relative mb-3 md:mb-5 overflow-hidden transition-all group-hover:shadow-xl">
                                <button 
